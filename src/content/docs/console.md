...
description: "Create your Factor BI Account and configure your first service."
---
...
![Factor BI Console Login](../../assets/img/Factor_BI_Console.png)
...
3.  Edit **Database** and **Description**, then click **Edit** again to save.
    ...
    **Database must be all lowercase. Can't contain special characters.**
    ...
    ![Factor BI Service numbers](../../assets/img/Factor_BI_Service_Numbers.png)
...
4.  Go to left pane **RDS Instances** and click under **Hostname**.
    ...
    *   Port
    ...
    ![Synchonization API Connection Details](../../assets/img/Factor_BI_RDS_Instances.png)
